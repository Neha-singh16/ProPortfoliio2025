...
export function Hero() {
  return (
    <section className="min-h-screen flex flex-col justify-center relative overflow-hidden px-4 sm:px-6 md:px-8 pt-24 sm:pt-20 md:pt-0">
      <div className="hidden sm:block absolute top-20 right-0 w-[500px] h-[500px] bg-purple-600/10 rounded-full blur-[120px] -z-10" />
      <div className="hidden sm:block absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[120px] -z-10" />

      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        {/* Left Content */}
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -top-8 sm:-top-12 -right-8 sm:-right-12 md:-right-4 w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 border border-dashed border-zinc-700 rounded-full flex items-center justify-center z-0"
          >
            <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 border border-zinc-800 rounded-full" />
          </motion.div>

          <div className="relative z-10 w-[240px] sm:w-[280px] md:w-[350px] aspect-4/5 group mx-auto lg:mx-0">
            {/* Card Container */}
            ...
            <motion.div
              ...
              className="absolute -bottom-4 sm:-bottom-6 -right-4 sm:-right-6 bg-green-500 text-black font-bold font-heading uppercase text-xs sm:text-sm py-3 px-3 sm:py-4 sm:px-4 rounded-full shadow-lg transform rotate-12 border-2 border-white z-20 flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 text-center leading-tight"
            >
              Good
              <br />
              Vibes
            ...
            <motion.div
              ...
              className="absolute top-6 sm:top-10 -left-6 sm:-left-10 bg-white text-black font-bold font-heading uppercase text-[10px] sm:text-xs py-1.5 px-3 sm:py-2 sm:px-4 rounded-full shadow-lg transform -rotate-12 z-20"
            >
              <Sparkles className="w-2.5 h-2.5 sm:w-3 sm:h-3 inline-block mr-1 text-purple-600" />
              2026 Grad
            </motion.div>
          </div>
        </motion.div>
